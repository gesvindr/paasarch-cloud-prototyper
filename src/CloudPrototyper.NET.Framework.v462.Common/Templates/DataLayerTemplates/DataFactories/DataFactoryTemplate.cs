...
namespace CloudPrototyper.NET.Framework.v462.Common.Templates.DataLayerTemplates.DataFactories
{
    ...
    #line 1 "C:\Users\ogasi_000\Documents\Visual Studio 2015\Projects\Prototyper\CloudPrototyper\CloudPrototyper.NET.Framework.v462.Common\Templates\DataLayerTemplates\DataFactories\DataFactoryTemplate.tt"
...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            this.Write(");\n\t\t\tvar method = classType.GetMethod(\"GetRowCount\");\n            var rows = (in" +
                    "t)method.Invoke(null, new object[] { dbName, typeof(");
...
private global::CloudPrototyper.NET.Framework.v462.Common.Generators.DataLayerGenerators.DataFactories.DataFactoryGenerator _ModelField;

/// <summary>
/// Access the Model parameter of the template.
/// </summary>
private global::CloudPrototyper.NET.Framework.v462.Common.Generators.DataLayerGenerators.DataFactories.DataFactoryGenerator Model
{
    get
    {
...
{
    this._ModelField = ((global::CloudPrototyper.NET.Framework.v462.Common.Generators.DataLayerGenerators.DataFactories.DataFactoryGenerator)(this.Session["Model"]));
...
if ((ModelValueAcquired == false))
{
    ...
    if ((data != null))
    {
        this._ModelField = ((global::CloudPrototyper.NET.Framework.v462.Common.Generators.DataLayerGenerators.DataFactories.DataFactoryGenerator)(data));
    }
}
